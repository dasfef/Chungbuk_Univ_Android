...
public class Map_Activity extends AppCompatActivity {
    ...
    private static final String TAG_LON = "longtitude";
    ...
    private void showResult(){
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                String longtitude = item.getString(TAG_LON);
                ...
                hashMap.put(TAG_LON, longtitude);
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    new String[]{TAG_NAME,TAG_ADDRESS,TAG_REVIEW,TAG_LAT,TAG_LON},
                    new int[]{R.id.textView_list_name, R.id.textView_list_address,R.id.textView_list_review,R.id.textView_list_latitude,R.id.textView_list_longtitude}
            );
